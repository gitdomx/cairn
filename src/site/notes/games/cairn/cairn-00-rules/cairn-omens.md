---
{"dg-publish":true,"permalink":"/games/cairn/cairn-00-rules/cairn-omens/","title":"Omens in Cairn","tags":["ttrpg/cairn"]}
---

# Omen
- roll on the table
- some rolls are read aloud
	- and some are kept personal

---
`dice:[[cairn-omens^cairn-omen]]`
...
| **20** | Border towns have become riotous in recent weeks after multiple claims of a red-robed figure appearing in their children’s dreams, uttering the same warning: A fire is coming, and it will consume everything. |{ #cairn-omen}
