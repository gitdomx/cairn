---
{"dg-publish":true,"permalink":"/games/cairn/cairn-background/cairn-bg-hexenbane/","title":"🛡️ Hexenbane","tags":["ttrpg/cairn/background"]}
---

# Hexenbane
[[games/cairn/cairn-home\|🔙 Backgrounds]] << [[games/cairn/cairn-background/cairn-bg-half-witch\|🧙🏻‍♀️ Half Witch]] | [[games/cairn/cairn-background/cairn-bg-jongleur\|🤡 Jongleur]] >>

> [!summary] You are a mere digit on the unerring hand of justice. You go where others fear to tread, unyielding and unbroken.

---
Randomiser:
`dice: [[cairn-bg-hexenbane^cairn-hexenbane-order]]`
`dice: [[cairn-bg-hexenbane^cairn-hexenbane-vow]]`
...
| **4** | **Order of the Blank Eye**. Take a **Voidglass Shard**. Peer through it to see invisible marks, creatures, and other magical effects. Lose the use of your eye for an hour afterwards (you are [[games/cairn/cairn-00-rules/cairn-basics#Deprived\|deprived]]). |
...
| **6** | **Order of the Silent Veil**. Take a **Quell Stone** (2 uses) wrapped in burlap. Extinguishes any nearby flames once exposed to air. |{ #cairn-hexenbane-order}
...
| **5** | **Charity**. Once per day you can shrug off a [[games/cairn/cairn-00-rules/cairn-basics#Fatigue\|fatigue]]. If your vow is ever broken, you permanently lose one inventory slot. |
| **6** | **Valor**. The first time you inflict [[games/cairn/cairn-00-rules/cairn-basics#Critical Damage\|critical damage]], you receive +d4 HP, returning to the previous limit at the end of combat. If your vow is broken, you die. |{ #cairn-hexenbane-vow}
